...
/**
 *
 * Main class for client who is a user.
...
public class JoinWhiteBoard {
    ...
    public static void main(String[] args){
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                WhiteboardApplication whiteboardApplication = new WhiteboardApplication(userAccess,
                        new WhiteboardGUI(userAccess, serverIPAddress, serverPort, finalUsername), triggerConnectButton);
